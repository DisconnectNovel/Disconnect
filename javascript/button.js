...
function updateText_d2_At_health_insurance() {
    ...
    text += "<br />L'agent avertit Aaron que s'il souhaite vraiment obtenir une assurance santé, le prix sera nettement plus élevé pour prendre en compte les facteurs de risque. Aaron, choqué, se rend compte qu'il n'est pas capable de payer une telle somme et qu'il doit abandonner l'idée de faire du basket. Une fois remis du choc, il sent une colère bouillonnante monter en lui: << Si je veux me faire assurer, c'est justement pour pour pouvoir faire du sport et par conséquent diminuer mes risques, pourquoi vous ne me laissez pas le faire ! >> fulmine-t-il en tapant du poing sur la table. La sécurité est appelée mais Aaron sort en coup de vent avant qu'elle n'ait eu le temps d'arriver.<br /><br />Une caméra à l'intérieur de la pièce a enregistré la scène.";
